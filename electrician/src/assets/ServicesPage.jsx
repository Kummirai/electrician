    ...
    <div className="min-vh-100 bg-light p-4">
      ...
      <section className="mt-6 row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        <div className="col">
          <Card className="h-100">
            <CardContent className="p-4 text-center">
              <img src="/images/emergency.jpg" alt="Emergency Repairs" className="w-100 h-40 object-cover rounded-lg" />
        ...
        <div className="col">
          <Card className="h-100">
            <CardContent className="p-4 text-center">
              <img src="/images/installations.jpg" alt="Installations & Upgrades" className="w-100 h-40 object-cover rounded-lg" />
        ...
        <div className="col">
          <Card className="h-100">
            <CardContent className="p-4 text-center">
              <img src="/images/consultation.jpg" alt="Free Consultation" className="w-100 h-40 object-cover rounded-lg" />
